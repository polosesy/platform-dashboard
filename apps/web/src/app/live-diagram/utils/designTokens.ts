...
export const defaultTokens: DesignTokenSet = {
  ...
  animation: {
    particleDuration: { none: 0, low: 3.0, medium: 2.0, high: 1.2, burst: 0.6 },
    particleCount: { none: 0, low: 1, medium: 2, high: 3, burst: 5 },
  ...
  dimensions: {
    ...
    particleRadius: { none: 0, low: 2.5, medium: 3, high: 3.5, burst: 4.5 },
    healthRingRadius: 17,
    healthRingStroke: 3,
  },
  typography: {
